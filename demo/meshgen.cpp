					...
					float radius)
{
  ...
  for(int i=0; i<=resolution; ++i){
	...
	for(int j=0; j<=resolution; ++j){
	  ...
	  vertexData.push_back(v0); vertexData.push_back(v1); vertexData.push_back(v2);
	  vertexData.push_back(v2); vertexData.push_back(v1); vertexData.push_back(v3);
	  tcoordData.push_back(tc0); tcoordData.push_back(tc1); tcoordData.push_back(tc2);
	  tcoordData.push_back(tc2); tcoordData.push_back(tc1); tcoordData.push_back(tc3);
	}
  }
}
